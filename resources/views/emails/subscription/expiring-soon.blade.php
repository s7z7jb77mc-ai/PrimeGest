      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:32px 40px 0;text-align:center;">
            <span style="display:inline-block;background:#FEF3C7;color:#92400E;border:1px solid #FCD34D;padding:6px 20px;border-radius:999px;font-size:13px;font-weight:700;letter-spacing:0.5px;">
              ⚠ Abonnement expirant dans {{ $joursRestants }} jours
            </span>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:28px 40px;">
            ...
            <p style="color:#374151;font-size:15px;margin:0 0 16px;">
              Votre abonnement <strong>{{ ucfirst($plan) }}</strong> pour <strong>{{ $entrepriseName }}</strong>
              arrive à expiration le <strong>{{ $expireDate }}</strong>.
            </p>
            <p style="color:#374151;font-size:15px;margin:0 0 24px;">
              Sans renouvellement, votre compte sera automatiquement repassé en plan <strong>Free</strong>
              et certaines fonctionnalités ne seront plus accessibles. Vos données restent conservées.
            </p>

            <!-- Récapitulatif -->
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#FEF3C7;border-radius:12px;padding:20px;margin:0 0 24px;">
              <tr>
                <td style="padding:8px 0;border-bottom:1px solid #FCD34D;">
                  <span style="color:#6B7280;font-size:13px;">Plan actuel</span>
              ...
              <tr>
                <td style="padding:8px 0;">
                  <span style="color:#6B7280;font-size:13px;">Expire le</span>
                  <span style="float:right;color:#92400E;font-size:13px;font-weight:700;">{{ $expireDate }}</span>
                </td>
              </tr>
            </table>
